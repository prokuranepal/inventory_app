...
const InventoryItem = props => {
    ...
    const sendCardHandlrer = (id) => {
        ...
        console.log('invent props ff',props,id,selected,selectedItemCart.title)
    };
                    ...
                    <ScrollView>
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={{ ...styles.label, marginTop: 0 }} data-test="medTitle">Medicine Name : {selectedItemCart.name}</Text>
            ...
            <TouchableOpacity onPress={props.onSelectItem} style={{width:"100%"}} data-test="touchCard">
                <View style={{width:"100%",alignItems:"center"}} >
                    <Card style={{...styles.summary, width:"86%", flexDirection:"row", justifyContent:"space-between"}}>
                        <ImageBackground source={props.image?{ uri: props.image }:{uri:"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ6BI5LFkyQySQrzWp5a3oirwKy3bqdwZxuDA&usqp=CAU"}} style={{ width: '100%', height: '100%', flex:1 }} />
